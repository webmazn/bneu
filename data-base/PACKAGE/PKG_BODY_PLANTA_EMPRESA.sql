...
--------------------------------------------------------
  ...
  BEGIN
    ...
    FROM T_GENM_PLANTA_EMPRESA	 
    WHERE   
    LOWER(TRANSLATE(denominacion,'¡…Õ”⁄·ÈÌÛ˙','AEIOUaeiou')) like '%'|| LOWER(TRANSLATE(piDenominacion ,'¡…Õ”⁄·ÈÌÛ˙','AEIOUaeiou')) ||'%' OR
    LOWER(TRANSLATE(direccion,'¡…Õ”⁄·ÈÌÛ˙','AEIOUaeiou')) like '%'|| LOWER(TRANSLATE(piDireccion ,'¡…Õ”⁄·ÈÌÛ˙','AEIOUaeiou')) ||'%' OR

...
var verificarCampoRuc = () => {
    ...
    if (arr.length > 0) {
        ...
        $('.seccion-mensaje').html(messageError(error));
        return false;
    }
    return true;
}
...
var grabarDatos = () => {
    ...
    let data = { idUsuario, idEmpresaIndustria, idRol, correoElectronico, nombres, dni, password, telefono, idEstado, idUsuarioCreacion: idUsuarioLogin };
